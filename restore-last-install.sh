...
restore_one rofi/yakushi-launcher-opacity.rasi "$HOME/.config/rofi/yakushi-launcher-opacity.rasi"
restore_one rofi/yakushi-opacity.rasi "$HOME/.config/rofi/yakushi-opacity.rasi"
restore_one rofi/powermenu.rasi "$HOME/.config/rofi/powermenu.rasi"
