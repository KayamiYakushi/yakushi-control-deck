...
- Simplified Rofi Studio to the two maintained presets that have distinct, tested behavior: **SIGNATURE** and **RAYCAST GLASS**. Removed the redundant Compact, Borderless, and Lounge cards.
- Promoted Waybar surface opacity into its own visible Bar Studio card. The control updates the live preview immediately and persists through both normal Apply and the Liquid Glass preset path.
